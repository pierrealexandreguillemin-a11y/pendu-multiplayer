  ...
  return (
    <main className="min-h-dvh flex flex-col items-center justify-center p-4 bg-gradient-to-b from-gray-900 to-gray-800">
      <div className="w-full max-w-md rounded-2xl border border-white/10 bg-white/5 p-8 text-center shadow-xl backdrop-blur-sm">
        <h1 className="mb-2 text-2xl font-bold text-white">Erreur dans le mode PvP</h1>
        ...
        <div className="flex flex-col gap-3">
          <button
            onClick={reset}
            className="w-full rounded-xl bg-pink-700 px-6 py-3 font-semibold text-white transition-all duration-200 hover:bg-pink-800 hover:shadow-lg hover:shadow-pink-500/30 focus:outline-none focus:ring-4 focus:ring-pink-500/50"
          >
            Réessayer
          </button>
          <Link
